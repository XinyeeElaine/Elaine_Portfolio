...
const PROJECTS = [
  ...
  },
  {
    ...
    slug: 'meow-ney-maker',
    summary: 'Pixel-art salary timer. Clock in, watch the ringgit tick up second-by-second, clock out to a DJ cat.',
    description: "Work is boring, but getting paid isn't. A retro pixel-art shift timer that turns your monthly salary into a live counter — enter salary, working hours, and working days, hit \"Welcome to HELL\", and watch your earnings climb by the second until you clock out.\n\nBuilt with plain HTML, CSS, and vanilla JavaScript — no framework, no build step, deployed straight from GitHub Pages. Supabase handles optional accounts, so sessions sync across devices when you log in and fall back to localStorage when you don't. Four swappable themes (Midnight, Peach, Mint, Lavender), a Press Start 2P pixel UI, a hard-working cat while the clock runs, and a DJ cat for the clock-out celebration.\n\nDashboard, Diary, and To-Do pages are scaffolded and in progress.",
    tags: ['Web app', 'Vanilla JS', 'Supabase', 'Pixel art', 'Productivity'],
    features: [
      'Live earnings counter — ticks up every second of the shift',
      'Salary, working hours, and working days drive the rate',
      'Clock out to an earnings summary and a DJ cat',
      'Session history — shifts, hours, and totals, with clear-all',
      'Optional Supabase login syncs history across devices',
      'Four pixel themes: Midnight, Peach, Mint, Lavender',
      'Dashboard, Diary, and To-Do pages in progress',
    ],
