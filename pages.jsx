...
const PROJECTS = [
  ...
  },
  {
    ...
    slug: 'meow-ney-maker',
    summary: 'A work timer that counts your pay by the second, then writes the day down for you — pixel-art dashboard, diary, and task boards.',
    description: "Work is boring, but getting paid isn't. A retro pixel-art shift timer that turns your monthly salary into a live counter — enter salary, working hours, and working days, clock in, and watch your earnings climb by the second until you clock out. Progress survives a refresh.\n\nThe timer grew into a whole workday companion. The dashboard tracks total earnings, hours, and shifts, with line charts for the month and year, bar graphs for the week, a sortable shift table, and PDF export. The diary opens like a book — logged shifts and expenses on one page, mood selector, tags, and notes on the other, plus a month calendar you can filter by mood or category. Task boards add colour-coded lists with star priorities, progress tracking, and pinning.\n\nBuilt on React 19 with React Router 7 and Vite 8, state in plain hooks, no chart library — every graph is inline SVG next to the hand-drawn pixel sprites. Supabase handles email and Google sign-in, PostgreSQL, and file storage so everything syncs across devices; guest mode keeps it all in the browser. Four themes (Midnight, Peach, Mint, Lavender), a hard-working cat while the clock runs, and a DJ cat for the clock-out celebration.",
    tags: ['Web app', 'React', 'Supabase', 'Pixel art', 'Productivity'],
    features: [
      'Live earnings counter — ticks up every second of the shift',
      'Salary, working hours, and working days drive the rate',
      'Dashboard — earnings, hours, and shifts with line and bar charts',
      'Sortable shift table with PDF export',
      'Diary — shifts and expenses beside mood, tags, and notes',
      'Month calendar filtered by mood or category',
      'Task boards — colour-coded lists, star priorities, pinning',
      'Email and Google sign-in syncs across devices; guest mode offline',
      'Four pixel themes: Midnight, Peach, Mint, Lavender',
    ],
    techStack: ['React 19', 'React Router 7', 'Vite 8', 'Supabase', 'PostgreSQL', 'CSS', 'Inline SVG'],
    glyph: 'M',
